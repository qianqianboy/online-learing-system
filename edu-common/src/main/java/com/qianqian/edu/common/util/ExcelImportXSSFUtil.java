...
public class ExcelImportXSSFUtil {
    ...
    public ExcelImportXSSFUtil(InputStream is, int seetIndex) throws IOException {
        this(is, seetIndex, true);
    }

    public ExcelImportXSSFUtil(InputStream is, int seetIndex, boolean evaluateFormular) throws IOException {
        super();
    ...
    public String getCellValue(Cell cell, int cellType) throws Exception {
        ...
        switch (cellType) {
            case Cell.CELL_TYPE_NUMERIC://0
                ...
                if (XSSFDateUtil.isCellDateFormatted(cell)) {//日期
